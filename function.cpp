...
double Function::compute_derivative( std::vector<double> point, std::vector<double> epsilon, double epsilon_scalar )
{
    double derivative;
...
std::vector<double> Function::get_gradient_approximation(std::vector<double> args, double delta)
{
